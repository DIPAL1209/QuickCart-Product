...
import { User, Mail, Lock, UserPlus, AlertCircle, CheckCircle2, Eye, EyeOff, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-10 bg-[var(--cloud)]">
      <div className="w-full max-w-sm">
        <div className="text-center mb-7">
          ...
          <h1 className="font-display text-2xl font-bold text-[var(--ink)]">Create your account</h1>
          <p className="text-[var(--muted)] text-sm mt-1">Join QuickCart in seconds</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 sm:p-7 rounded-2xl shadow-lg shadow-[var(--primary)]/5 border border-[var(--line)]">
          ...
          {success && (
            <div className="flex items-center gap-2 text-[var(--success)] text-sm bg-emerald-50 p-3 rounded-xl">
          ...
          <div>
            ...
            <div className="relative">
              <User size={17} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--muted)]" />
              <input
                type="text"
                value={fullName}
          ...
          <p className="text-sm text-center text-[var(--muted)]">
            ...
            <Link href="/login" className="text-[var(--accent)] font-semibold cursor-pointer">
              Login
            </Link>
          </p>
        </form>
